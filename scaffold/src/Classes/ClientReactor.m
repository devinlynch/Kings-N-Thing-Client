...
-(NSDictionary*) loadPropertiesFile {
    ...
    plistPath = [rootPath stringByAppendingPathComponent:@"clientReactor.plist"];
    if (![[NSFileManager defaultManager] fileExistsAtPath:plistPath]) {
        plistPath = [[NSBundle mainBundle] pathForResource:@"clientReactor" ofType:@"plist"];
    }
