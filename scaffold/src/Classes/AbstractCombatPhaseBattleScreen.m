...
-(void) showPiecesForBattleForMe{
    if([_battle amIAttacker]) {
        [self showPiecesMenuForPlayer:_battle.attacker onLocation:(BoardLocation*)_battle.locationOfBattle];
    } else{
        [self showPiecesMenuForPlayer:_battle.defender onLocation:(BoardLocation*)_battle.locationOfBattle];
    }
}
